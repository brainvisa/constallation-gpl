...
def initialization(self):
    ...
    eNode.addDoubleLink("CreateMask.study", "study")
    eNode.addDoubleLink("CreateMask.texture_group", "texture_group")
    eNode.addDoubleLink("CreateMask.patch_label", "patch_label")
    eNode.addDoubleLink("CreateMask.smoothing", "smoothing")
    ...
    eNode.addDoubleLink("ConnectivityProfileGroup.study", "study")
    eNode.addDoubleLink(
        "ConnectivityProfileGroup.texture_group", "texture_group")
    eNode.addDoubleLink("ConnectivityProfileGroup.patch_label", "patch_label")
    eNode.addDoubleLink("ConnectivityProfileGroup.smoothing", "smoothing")
    eNode.addDoubleLink("ConnectivityProfileGroup.group", "group")

    # link of parameters with the "Normed Connectivity Profile of Group"
    # process
    ...
    eNode.addDoubleLink("ReducedMatrixGroup.study", "study")
    eNode.addDoubleLink("ReducedMatrixGroup.texture_group", "texture_group")
    eNode.addDoubleLink("ReducedMatrixGroup.patch_label", "patch_label")
    eNode.addDoubleLink("ReducedMatrixGroup.smoothing", "smoothing")
    ...
    eNode.addDoubleLink("ClusteringGroup.texture_group", "texture_group")
